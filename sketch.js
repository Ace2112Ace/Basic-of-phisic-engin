...
function setup() {
  ...
  //whenever we create a engine a world gets created already with it
   ...
   var ball_options = {
    ...
    //the larger the number is the more bouncy the object will become and vice versa
    frictionAir:0.01
    //it if friction in the air and depends on the weight of the object
  }
...
//we are creating our object i.e ground from Bodies
  ...
  Bear=Bodies.circle(150,10,20,ball_options)
  World.add(world,Bear)
  
  Bear2=Bodies.rectangle(50,10,30,40,ball_options)
  World.add(world,Bear2)
...
function draw() 
{
  ...
  ellipse(Bear.position.x,Bear.position.y,30)
  rect(Bear2.position.x,Bear2.position.y,40,40)
